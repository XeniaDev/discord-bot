...
Client.on('message',message=>{
  if (message.content == 'bayo!hi'){
   ...
   message.reply('call me Bayonetta!');
    ...
    message.send(">>> I'm a very basic bot made by BayoDino and Haruyuki and Ergastolator1. I'll become a helper for Cranterns bot ^-^, Ergastolator1 is not a person that made it, BTW :) He only helped to make it, but thanks for including him anyways in the command!");
